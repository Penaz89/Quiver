...
var translations = map[string]map[string]string{
	...
	"finances.housing":         {"en": "Rent/Mortgage", "it": "Affitto/Mutuo"},
	"housing.noRecords":        {"en": "No rent/mortgage expenses yet.", "it": "Nessuna spesa per affitto/mutuo."},
	...
	"finances.daily":           {"en": "Expenses", "it": "Spese"},
	"daily.noRecords":          {"en": "No expenses yet.", "it": "Nessuna spesa."},
	...
	"finances.categories":      {"en": "Expense Categories", "it": "Categorie di spesa"},
	"categories.title":         {"en": "Expense Categories", "it": "Categorie di spesa"},
	"categories.noRecords":     {"en": "No categories found.", "it": "Nessuna categoria."},
	...
	"finances.transfers":       {"en": "Transfers", "it": "Giroconti"},
	"transfers.noRecords":      {"en": "No transfers found.", "it": "Nessun giroconto."},
	...
	"col.fromAccount":          {"en": "FROM", "it": "DA"},
	"col.toAccount":            {"en": "TO", "it": "A"},
	...
	"field.date":               {"en": "Date", "it": "Data"},
	"field.frequency":          {"en": "Frequency", "it": "Frequenza"},
