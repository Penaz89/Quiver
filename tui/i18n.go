...
var translations = map[string]map[string]string{
	...
	"finances.estimateNote":    {"en": "The annual value for daily expenses is an\n    estimate based on the current month.", "it": "Il valore annuale per le spese giornaliere è\n    una stima basata sul mese corrente."},
	...
	"col.annualEstimate":       {"en": "ANNUAL EST.", "it": "STIMA ANNUALE"},
